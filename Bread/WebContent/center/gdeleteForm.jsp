...
<article>
<h1>Gallery Write</h1>
<form action="gdeletePro.jsp" method="post" name="fr" enctype="multipart/form-data">
...
<tr><td class="twrite">제목</td>
    <td class="ttitle"><input type="text" name="subject" value="<%=gb.getSubject()%>"></td></tr>
<%
if(gb.getFile() == null){
	%>
	...
	%>
	<tr><td class="twrite">첨부파일</td><td colspan="3"><%=gb.getFile() %></td></tr>
...
<tr><td class="twrite">첨부파일</td>
    <td class="tittle"><input type="file" name="file" ></td></tr>
<tr><td class="twrite">글내용</td>
    <td class="ttitle"><textarea name="content" rows="10" cols="20" ><%=gb.getContent()%></textarea></td></tr>
</table>
<div id="table_search">
<input type="submit" value="글 삭제" class="btn">
<input type="button" value="뒤로 가기" class="btn" 
